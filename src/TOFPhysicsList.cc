...
void TOFPhysicsList::ConstructBosons()
{
...
void TOFPhysicsList::ConstructLeptons()
{
  // leptons
...
void TOFPhysicsList::ConstructMesons()
{
 //  mesons
...
void TOFPhysicsList::ConstructBaryons()
{
//  barions
...
void TOFPhysicsList::ConstructGeneral()
{
  // Add Decay Process
...
void TOFPhysicsList::ConstructEM()
{
  theParticleIterator->reset();
  while( (*theParticleIterator)() ){
    G4ParticleDefinition* particle = theParticleIterator->value();
...
void TOFPhysicsList::ConstructOp()
{
...
void TOFPhysicsList::SetVerbose(G4int verbose)
{
...
void TOFPhysicsList::SetNbOfPhotonsCerenkov(G4int MaxNumber)
{  
